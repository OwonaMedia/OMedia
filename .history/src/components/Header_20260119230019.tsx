      ...
      >
        <div className="mt-20 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 mb-4 border-b border-white/10 pb-8">
            ...
            <Link to="/blog" onClick={closeMenu} className="text-white/80 text-lg hover:text-[#D4AF37] uppercase tracking-widest transition-colors">{t('menu.blog')}</Link>
          </div>
          ...
          <Link to="/blog" onClick={closeMenu} className="text-3xl font-light hover:text-[#D4AF37] transition-colors">{t('menu.blog')}</Link>
