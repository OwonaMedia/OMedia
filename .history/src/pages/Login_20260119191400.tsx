  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (email === TEST_EMAIL && password === TEST_PASSWORD) {
        ...
        setLoading(false);
        setError('Invalid credentials. Use the test account below.');
      }
    }, 1000);
  };
    ...
    <Layout darkBg={false}>
      <div className="bg-white min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="mb-6 bg-gray-50 border border-gray-200 rounded-lg p-4 text-xs text-gray-600">
            <div className="mb-1 font-semibold text-black">Test-Account für Dashboard:</div>
            <div>Email: <span className="font-mono">client@example.com</span></div>
            <div>Password: <span className="font-mono">test1234</span></div>
          </div>
