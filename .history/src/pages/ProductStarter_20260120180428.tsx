...
export default function ProductStarter() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-20 px-4 bg-white rounded-3xl shadow-xl border border-[#D4AF37]/20">
      <h1 className="text-5xl font-light mb-4 text-[#D4AF37] text-center tracking-tight drop-shadow-lg">{t('product.starter.detail.title')}</h1>
      ...
      <div className="grid md:grid-cols-2 gap-10 mb-10">
        <div className="flex flex-col gap-6">
          <div className="bg-[#FFF8E1] border-l-4 border-[#D4AF37] p-6 rounded-xl shadow-sm">
            ...
            <p className="text-gray-900 text-base">{t('product.starter.detail.target')}</p>
          </div>
          <div className="bg-[#F5F5F5] border-l-4 border-[#D4AF37] p-6 rounded-xl shadow-sm">
            ...
            <p className="text-gray-900 text-base">{t('product.starter.detail.features')}</p>
          </div>
          <div className="bg-[#F5F5F5] border-l-4 border-[#D4AF37] p-6 rounded-xl shadow-sm">
            <h2 className="text-xl font-bold text-[#D4AF37] mb-2">Vorteile</h2>
            <p className="text-gray-900 text-base">{t('product.starter.detail.benefits')}</p>
          </div>
        </div>
        <div className="flex flex-col gap-6">
          <div className="bg-[#F5F5F5] border-l-4 border-[#D4AF37] p-6 rounded-xl shadow-sm">
            <h2 className="text-xl font-bold text-[#D4AF37] mb-2">Technik</h2>
            <p className="text-gray-900 text-base">{t('product.starter.detail.tech')}</p>
          </div>
          <div className="bg-[#F5F5F5] border-l-4 border-[#D4AF37] p-6 rounded-xl shadow-sm">
            <h2 className="text-xl font-bold text-[#D4AF37] mb-2">Service</h2>
            <p className="text-gray-900 text-base">{t('product.starter.detail.service')}</p>
          </div>
          <div className="bg-[#F5F5F5] border-l-4 border-[#D4AF37] p-6 rounded-xl shadow-sm">
            <h2 className="text-xl font-bold text-[#D4AF37] mb-2">Add-ons</h2>
            <p className="text-gray-900 text-base">{t('product.starter.detail.addons')}</p>
          </div>
        </div>
      </div>
